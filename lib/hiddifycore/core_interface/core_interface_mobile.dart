...
import 'package:uflow/core/utils/laststeam.dart';
...
final _logger = Loggy('FFIU FlowCoreService');

class CoreInterfaceMobile extends CoreInterface with InfraLogger {
  static const channelPrefix = "com.uflow.app";
  ...
  Future<String> setup(Directories directories, bool debug, int mode) async {
    ...
    // await start("/sdcard/Android/data/app.uflow.com/files/configs/cdc633e9-8cfc-4a67-948d-009f779a5c91.json", "uflow");
    return "";
  }
