...
class CoreClient extends $grpc.Client {
  ...
  static final _$changeU FlowSettings =
      $grpc.ClientMethod<$0.ChangeU FlowSettingsRequest, $0.CoreInfoResponse>(
          '/hcore.Core/ChangeU FlowSettings',
          ($0.ChangeU FlowSettingsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.CoreInfoResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.CoreInfoResponse> changeU FlowSettings(
      $0.ChangeU FlowSettingsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$changeU FlowSettings, request, options: options);
  }
...
abstract class CoreServiceBase extends $grpc.Service {
  ...
  CoreServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ChangeU FlowSettingsRequest,
            $0.CoreInfoResponse>(
        'ChangeU FlowSettings',
        changeU FlowSettings_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ChangeU FlowSettingsRequest.fromBuffer(value),
        ($0.CoreInfoResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.StartRequest, $0.CoreInfoResponse>(
        'StartService',
        startService_Pre,
  ...
  $async.Future<$0.CoreInfoResponse> changeU FlowSettings_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ChangeU FlowSettingsRequest> request) async {
    return changeU FlowSettings(call, await request);
  }
  ...
  $async.Future<$0.CoreInfoResponse> changeU FlowSettings(
      $grpc.ServiceCall call, $0.ChangeU FlowSettingsRequest request);
