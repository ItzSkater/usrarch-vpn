...
import 'package:uflow/core/haptic/haptic_service.dart';
import 'package:uflow/core/http_client/http_client_provider.dart';
...
import 'package:uflow/features/profile/add/model/free_profiles_model.dart';
...
import 'package:uflow/utils/riverpod_utils.dart';
...
class FreeProfilesNotifier extends _$FreeProfilesNotifier {
  ...
  Future<List<FreeProfile>> build() async {
    ...
    final res = await httpClient.get(
      'https://raw.githubusercontent.com/uflow/uflow-app/refs/heads/main/test.configs/free_configs',
    );
