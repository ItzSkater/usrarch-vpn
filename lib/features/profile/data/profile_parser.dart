...
import 'package:uflow/singbox/model/singbox_proxy_type.dart';
    ...
    final rs = await _httpClient
        .download(
          ...
          userAgent: _ref.read(ConfigOptions.useXrayCoreWhenPossible)
              ? _httpClient.userAgent.replaceAll("U FlowNext", "U FlowNextX")
              : null,
        )
        .catchError((err) {
        ...
        try {
          ...
          await httpClient.download(
            ...
            userAgent: ref.read(ConfigOptions.useXrayCoreWhenPossible)
                ? httpClient.userAgent.replaceAll('U FlowNext', 'U FlowNextX')
                : null,
          );
